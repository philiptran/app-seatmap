...
/**
 * A view representing a MapView marker information text.
 * 
 * @author philiptran
 * 
 */
public class TextOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	/**
	 * Inflate and initialize the UI. Override this method to provide a custom
	 * view/layout for the callout.
	 * 
	 * @param context
	 *            - The activity context.
	 * @param parent
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		View v = inflater.inflate(R.layout.text_overlay, parent);
		title = (TextView) v.findViewById(R.id.text_overlay_title);
	}
